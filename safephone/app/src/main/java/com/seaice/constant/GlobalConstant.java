package com.seaice.constant;

/**
 * Created by seaice on 2016/3/23.
 */
public class GlobalConstant {

    //pref constant
    public static final String PREF_OPEN_LOST_PROTECT = "open_lost_protect";
    public static final String PREF_SAFE_PHONE_NUMBER = "safe_phone_number";
    public static final String PREF_SIM_SERIAL = "sim_serial";
    public static final String PREF_SAFE_PHONE_FINISH = "safe_phone_finish";
