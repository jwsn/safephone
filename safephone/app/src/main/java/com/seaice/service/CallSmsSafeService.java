...
public class CallSmsSafeService extends Service {
    ...
    private CallSmsStateReceiver mCallSmsReceiver;
    ...
    public void onDestroy() {
        ...
        unregisterReceiver(mCallSmsReceiver);
        mCallSmsReceiver = null;
    }
        ...
        public void onCallStateChanged(int state, String incomingNumber) {
            ...
            switch (state) {
                case TelephonyManager.CALL_STATE_RINGING: {
                    ...
                    //Log.e(TAG, "INCOMING CALL");
                    Log.e(TAG, "123" + incomingNumber);
                    if (incomingNumber == null) {
                        Log.e(TAG, "incomingNumber = null");
                    }
                    HomeCallDbMgr.initDataBase(CallSmsSafeService.this);
